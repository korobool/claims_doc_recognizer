...
* Works absolutely locally, so it is applicable for sensitive data processing so that you can comply with even very strict security standards in EN, UK and US including GDRP, ISO27001, FDA etc.
